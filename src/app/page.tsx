        ...
        <div className="flex gap-5 items-stretch flex-col md:flex-row">
          ...
          <div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm md:text-base">
              Um evento feito para pessoas desenvolvedoras apaixonadas por criar
              soluções inovadoras e compartilhar conhecimento. Vamos mergulhar
              nas tendências mais recentes em desenvolvimento de software,
              arquitetura de sistemas e tecnologia emergentes, com palestras,
              workshop e hackathons.
              <br />
              <br />
